const BASE_URL_TASKS = "https://myjoin-41d23-default-rtdb.europe-west1.firebasedatabase.app/tasks";
let tasks = [];

const BASE_URL_ASSIGNED = "https://myjoin-41d23-default-rtdb.europe-west1.firebasedatabase.app/tasks";
let bigassigned = [];
